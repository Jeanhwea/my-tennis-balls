...
bool HUD::initWithSize(const Size &visibleSize)
{
    ...
    _ballCountLabel = Label::createWithSystemFont("Balls: 0", "Arial", FONT_SZ - 2);
    ...
    _targetLabel = Label::createWithSystemFont("Targets: 0", "Arial", FONT_SZ - 2);
...
{
    auto cleared = Label::createWithSystemFont("ALL CLEAR!", "Arial", 52);
    cleared->setPosition(
